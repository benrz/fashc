		...
		<div class="container-fluid col-lg-11  product">
			<table class="table table-striped table-bordered" cellspacing="0" width="100%">
				<?php
					...
					echo "<tr>";
					if(isset($itemSearchName)){
						foreach($itemSearchName as $itemGroup){
							...
							echo "<td class='col-3'>";
								...
								echo "<div class='p-3 bg-light'>";
									...
									if($customerLikes){
										...
										echo "<span id='likeButton".$itemID."' class='glyphicon glyphicon-heart' style='color: white;' onclick='likeFunction(".$itemID.",\"".$user_id."\")'></span>";
